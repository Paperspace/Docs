...
For AWS, the Gradient installer will utilize Terraform to provision an Elastic Kubernetes Service \(EKS\) cluster. You must follow the [pre-installation steps](../pre-installation-steps.md) before continuing.
