...
These are the templates that are most popular on Gradient.  They include the most common ML frameworks and libraries.  [Click here](create-a-notebook/notebook-containers/) to discover which Notebook Base Container will best suit your use case, then choose it from the options below:

![Recommended containers](../../.gitbook/assets/screen-shot-2021-01-18-at-9.34.22-pm.png)

#### All Containers (Basic)

These are additional templates that are made available in Gradient as a 1-click option.  [Click here](create-a-notebook/notebook-containers/) to discover which Notebook Base Container will best suit your use case, then choose it from the options below:

![All containers](../../.gitbook/assets/screen-shot-2021-01-18-at-9.35.10-pm.png)

#### Custom Containers (Advanced)

If you need to import an existing container, visit the Custom Containers section. Learn more [here](create-a-notebook/notebook-containers/).
