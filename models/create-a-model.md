...
You can do this [via the UI]() or [via the CLI]() by [using one of the sample Experiment commands](); be sure to set both `--modelPath` and `--modelType` according to those instructions. This will place your Model in your Project's [Model Repository](about.md#model-repository).  
