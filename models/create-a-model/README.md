...
{% tab title="CLI" %}
You can upload a Model via the CLI by running the following command:

```text
gradient models upload
```
...
Now that you have a Model, whether uploaded or generated by running an Experiment, read this [article](../../deployments/managing-deployments/#create-a-deployment) to learn how you can use it to create a Deployment.
{% endtab %}
{% endtabs %}
