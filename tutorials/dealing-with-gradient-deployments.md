...
`export SERVE_URL=`[`https://services.paperspace.io/model-serving/deslid8n74p4bvs:predict`](https://services.paperspace.io/model-serving/deslid8n74p4bvs:predict)`python infer.py`
