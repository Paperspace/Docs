...
Gradient Public profiles are still very much a work-in-progress. Notebooks are the first feature to be enabled for showing up on profiles, but soon we will be adding [Projects](), [Models](../models/create-a-model.md), [Datasets](../data/managing-data-in-gradient/), and more.
